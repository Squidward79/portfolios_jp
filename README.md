...
<img width="350" src = "https://user-images.githubusercontent.com/45874696/67147952-d01c1280-f2d4-11e9-9845-5e3000757c42.png">
...
- **使用ツール：** Unity3D/C#
- **製作人数：** 2人（**プログラマ**とデザイナー）
- **説明** </br>
  夏休みに友達の誕生日プレゼントで作ったホラーアドベンチャーゲームです。「青鬼」というホラーゲームを参考にして作りました。
  プレイヤーを追いかけてくる鬼を避けて地域を探索し、手がかりを集めて会社を脱出するゲームです。
...
- **使用ツール：** Unity3D/C#
- **製作人数：** ９人チーム（プランナー3人、**プログラマ**1人、デザイナー4人、サウンド1人）
- **説明** </br>
...
- **プレイタイム-：**　1時間半～3時間
- **プラットフォーム：** PC
- **製作期間：** ２０１９．０６ ～　２０１９．０８
- **使用ツール：** Unity3D/C#
- **製作人数：** ３人チーム（プランナー、**プログラマ**、デザイナー）
- **説明** </br>
 友達にプレセントするため作った戦略 너라ㅣ너ㅣ란어ㅣㅏㄹ너ㅣ라여기 쓰기
 様々なユニットが戦うアルゴリズムを制作したり、ステージレベリングツールを作ったり、２Dを３Dに見えるように視点を試したりなど、新しい挑戦ができたプログラムです。

   친구 생일선물주려고만든 게임 2탄. 전략 디펜스게임으로 
...
- **プレイタイム-：**　1時間
- **プラットフォーム：** PC
- **製作期間：** ２０１９．０4 ～　２０１９．０6
- **使用ツール：** Unreal Engine/BluePrint
- **製作人数：** ３人（プログラマ3人）
- **説明** </br>
 課題でUnreal Engineを使って制作したホラーゲームです。実際の学校を背景にして、マップを作り出しました。
