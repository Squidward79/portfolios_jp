...
- **説明** </br>
  ...
  初めて3人以上のチームでゲーム製作をしましたが、コミュニケーションがうまくいかず、結果に満足できませんでした。
  1次目標まで完成後チームが解体されたが、開発で作業物の整理とコミュニケーションの重要性を悟ることができました。
  
처음으로 ３인이상의 팀에서 제작을 했습니다만, 커뮤니케이션이 잘 이루어지지 않아 결과물이 만족스럽지는 못했습니다.
1차 목표까지 완성 후 팀이 해산되어 버렸지만 개발에 있어 작업물의 정리와 커뮤니케이션의 중요성을 깨달을 수 있었습니다.
